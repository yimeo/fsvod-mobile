...
const styles = StyleSheet.create({
  ...
  inlineDownloadButton: { width: 49, paddingHorizontal: 4, backgroundColor: "#263A57", borderLeftWidth: 1, borderLeftColor: "#405778", justifyContent: "center", alignItems: "center" },
