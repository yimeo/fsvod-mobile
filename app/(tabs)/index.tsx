...
import { getCachedIndexAds, loadIndexAds, type IndexAd } from "@/lib/index-ad";
...
export default function HomeScreen() {
  ...
  const [indexAds, setIndexAds] = useState<IndexAd[]>(() => getCachedIndexAds()?.ads ?? []);
...
const styles = StyleSheet.create({
  ...
  continueCard: { flexDirection: "row", gap: 12, marginTop: 13, alignItems: "center", alignSelf: "flex-start" },
  continuePoster: { width: 132, height: 74, borderRadius: 10 },
  continueInfo: { width: 175, minHeight: 74, justifyContent: "center", paddingVertical: 2 },
  continueTitle: { color: "#F0F2F7", fontSize: 14, lineHeight: 19, fontWeight: "900" },
  continueMeta: { color: "#9CA9BC", fontSize: 12, lineHeight: 18, marginTop: 5 },
  continueLine: { height: 4, borderRadius: 2, overflow: "hidden", backgroundColor: "#263249", marginTop: 9 },
